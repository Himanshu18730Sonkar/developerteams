...
const Navbar = () => {
  ...
  return (
    <nav
      className={`w-[90%] bg-gradient-to-r from-[#1a1a1a] to-[#2d2d2d] border-b-2 border-[#ff6b35] fixed top-8 left-1/2 -translate-x-1/2 z-1000 shadow-lg shadow-[rgba(255,107,53,0.3)] rounded-2xl transition-all duration-300 ${
